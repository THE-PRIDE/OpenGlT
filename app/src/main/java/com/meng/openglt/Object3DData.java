...
public class Object3DData {
	...
	// derived data
	private BaseBoundingBox baseBoundingBox;
	...
	public BaseBoundingBox getBaseBoundingBox() {
		FloatBuffer vertexBuffer = getVertexBuffer();
		if (vertexBuffer == null){
			vertexBuffer = getVertexArrayBuffer();
		}
		if (baseBoundingBox == null) {
			baseBoundingBox = BaseBoundingBox.create(getId()+"_BoundingBox", vertexBuffer, getModelMatrix());
		}
