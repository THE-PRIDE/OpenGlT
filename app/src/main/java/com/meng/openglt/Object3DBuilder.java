...
//		}
	...
	public static Object3DData buildBoundingBox(Object3DData obj) {
		BoundingBox boundingBox = new BoundingBox(obj.getBaseBoundingBox(),
				obj.getColor());
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(BaseBoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(BaseBoundingBox box) {
		//@formatter:off
