...
public final class BaseBoundingBox {
    ...
    public static BaseBoundingBox create(String id, FloatBuffer vertexBuffer, float[] modelMatrix) {
        ...
        return new BaseBoundingBox(id, min[0], max[0], min[1], max[1], min[2], max[2]);
    }

    public BaseBoundingBox(String id, float xMin, float xMax, float yMin, float yMax, float zMin, float zMax) {
        this.id = id;
        this.xMin = xMin;
        this.xMax = xMax;
        this.yMin = yMin;
